...
{{--                            this is for article input--}}
                            <div>
                                ...
                                <x-input id="title" class="w-full rounded-none my-4" value="{{$article->title}}" name="title" type="text" required autofocus/>
                            </div>
...
{{--                                <x-input id="taginput" name="tags" class="w-full rounded-none my-4"--}}
{{--                                         value="--}}
{{--                                @foreach($tags as $tag)--}}
{{--                                {{$tag->slug}}--}}
{{--                                @endforeach"  type="text" required autofocus/>--}}
...
{{--                            this is the article content input--}}
                            ...
                            <div class="toolbar w-full h-auto flex flex-row p-2 mb-3 justify-center border border-gray-200 bg-gray-100 sticky top-0" id="trix-toolbar">
                                ...
                                <input id="x" type="hidden" name="contents" value="{{$article->content}}">
